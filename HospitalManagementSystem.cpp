...
void adminAddPatient(){
    ...
    cin.ignore(1, '\n');
    getline(cin,patientsFileName);

    cout << "--> Enter patient's first name: ";
    getline(cin, patientsFirstName);

    cout << "--> Enter patient's middle name: ";
    getline(cin, patientsMiddleName);

    cout << "--> Enter patient's last name: ";
    getline(cin, patientsLastName);

    cout << "--> Enter patient's age: ";
    getline(cin, patientsAge);

    cout << "--> Enter patient's gender: ";
    getline(cin, patientsGender);

    cout << "--> Enter patient's mobile number: ";
    getline(cin, patientsMobileNumber);

    fflush(stdin);

    cout << "--> Enter patient's address: ";
    getline(cin, patientsAddress);
...
void adminAddDoctor(){
    ...
    system("clear");
    cout << endl << "================== ENTER DOCTOR'S DETAILS ==================" << endl;
    cout << "--> Enter doctor's first name: ";
    cin.ignore(1,'\n');
    getline(cin,doctorsFirstName);

    cout << "--> Enter doctor's middle name: ";
    getline(cin, doctorsMiddleName);

    cout << "--> Enter doctor's last name: ";
    getline(cin, doctorsLastName);

    cout << "--> Enter doctor's degree: ";
    getline(cin, doctorsDegree);

    cout << "--> Enter doctors's specialization: ";
    getline(cin, doctorsSpecialization);

    fflush(stdin);

    cout << "--> Enter doctor's age: ";
    getline(cin, doctorsAge);

    fflush(stdin);

    cout << "--> Enter doctor's mobile number: ";
    getline(cin, doctorsMobileNumber);

    fflush(stdin);

    cout << "--> Enter doctor's email: ";
    getline(cin, doctorsEmail);

    cout << "--> Enter doctors's address: ";
    getline(cin, doctorsAddress);
...
void doctorUpdatePatient(){
    ...
    if(!isFileFound){
        ...
        system("clear");
        cout << endl << "================== UPDATE " << patientsFileName << "'s Details ========================" << endl << endl;
        cout << "--> Enter patient's blood group: ";
        cin.ignore(1,'\n');
        getline(cin, patientsBloodGroup);

        cout << "--> Enter patient's symptoms: ";
        getline(cin, patientsSymptoms);
       
         
        cout << "--> Enter patient's medicines: ";
        getline(cin, patientsMedicines);

        cout << "--> Enter doctor's checked by: ";
        getline(cin, patientsCheckedBy);
...
void searchPatient(int way){


    int choice;
    system("clear");
    cout << "============= Search ==============" << endl;
    cout << "1. All Patients" << endl << "2. Specific Patient" << endl << "3. Back" << endl << "Enter your choice: ";
    cin >> choice;
...
static int searchAllPatientsCallback(void* data, int argc, char** argv, char** azColName)
{
    int i;
    string col[12] = {"File name", "First name", "Middle name", "Last name", "Mobile number", "Address", "Gender", "Age", "Blood group", "Symptoms", "Medicines", "Checked by"};
    for (i = 0; i < argc; i++) {
...
void searchAllPatients(){
    system("clear");
    cout << "================== SEARCH ALL PATIENTS RESULT ================" << endl << endl;
    string searchQuery = "SELECT * FROM Patients";
    int rc = sqlite3_exec(db, searchQuery.c_str(), searchAllPatientsCallback, 0, &errorMessage);
...
void searchSpecificPatient(int way){
    string patientsFileName;
    bool isFileFound = false; 
